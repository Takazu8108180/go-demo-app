...
import (
	...
	"github.com/takazu8108180/go-demo-app/ent/migrate"
...
// QueryComment queries the comment edge of a Article.
func (c *ArticleClient) QueryComment(a *Article) *CommentQuery {
...
type (
	hooks struct {
		Article, Comment []ent.Hook
	}
	inters struct {
		Article, Comment []ent.Interceptor
	}
)
